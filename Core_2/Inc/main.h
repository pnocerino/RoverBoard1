...
/* Private defines -----------------------------------------------------------*/
#define RTS_B2_Pin GPIO_PIN_0
#define RTS_B2_GPIO_Port GPIOC
#define CTS_B2_Pin GPIO_PIN_1
#define CTS_B2_GPIO_Port GPIOC
#define GVAIRO_Pin GPIO_PIN_5
#define GVAIRO_GPIO_Port GPIOA
#define BOARD_ALIVE_B2_Pin GPIO_PIN_11
#define BOARD_ALIVE_B2_GPIO_Port GPIOA
#define BOARD_ALIVE_B1_Pin GPIO_PIN_12
